...
function FacturasPorPagar(){
    ...
    `));
    $('#Contenido').html($(`
        <div class="col-12 row text-center" id="color-tittle-list-bills-pay">
            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-2 col-6 "><h2 class="sizeLetters">Nombre Proveedor</h2></div>
            ...
            <div class="col-sm-4 col-md-3 col-lg-3 col-xl-2 col-4 "><h2 class="sizeLetters">Estado</h2></div>
        </div>
        <div class="line-contenido"></div>
    `))
    $('#Contenido').append($(`
        <div class="col-12" id="List-style-bills-pay" >
            <div class="col-12 row text-center" id="color-descriptionA-list-bills-pay">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-2 col-6 "><input type="button" onclick="infoBillsPay()" class="sizeLetters Button-bills-provider" Value="Truper"></div>
                ...
                <div class="col-sm-4 col-md-3 col-lg-3 col-xl-2 col-4 ">
                <select id="slc-estado" class="form-control pl-0 pr-0 ml-0 mr-0 mt-1 mb-2" style="font-size:15px;">
                <option>Pagado</option>
                <option>Pendiente</option>
                </select>
                </div>
            </div>
            <div class="col-12 row text-center" id="color-descriptionB-list-bills-pay">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-2 col-6 "><input type="button" onclick="infoBillsPay()" class="sizeLetters Button-bills-provider" Value="CementosX"></div>
