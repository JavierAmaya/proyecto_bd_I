...
function FacturasPorPagar(){
    ...
    $('#Contenido').html($(`
        <div class="col-12 row" id="color-tittle-list-bills-pay">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">Facturas</h2></div>
            <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">fecha emitida</h2></div>
            <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">Nombre Limited</h2></div>
    ...
    $('#Contenido').append($(`
        <div class="col-12" id="List-style-bills-pay" >
            <div class="col-12 row" id="color-descriptionA-list-bills-pay">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3 col-6 "><h2 class="sizeLetters">Truper</h2></div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">00000102001</h2></div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">11/01/2020</h2></div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">26/01/2020</h2></div>
            ...
            <div class="col-12 row" id="color-descriptionB-list-bills-pay">
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3 col-6 "><h2 class="sizeLetters">CementosX</h2></div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">00000102002</h2></div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">12/03/2020</h2></div>
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-1 col-6 "><h2 class="sizeLetters">12/04/2020</h2></div>
