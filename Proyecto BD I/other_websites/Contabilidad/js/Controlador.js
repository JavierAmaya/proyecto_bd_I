...
function FacturasPorPagar(){
    ...
    `));
    $('#Contenido').html($(`
        <div class="col-12 row mt-2 pt-1 text-center" id="color-tittle-list-bills-pay">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-6 "><h2 class="sizeLetters">Fecha Limite</h2></div>
    ...
    `))
    $('#Contenido').append($(`
        <div class="col-12  text-center" id="List-style-bills-pay" >
    ...
    $('#Contenido').html($(`
        <div class="row" id="C´-Prducts" style=" margin-left: auto; margin-right: auto; width: 98%; "style=" margin-left: auto; margin-right: auto; width: 98%; ">
            <div class=" col-12" id="C-Products">
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-12 Div-Products" onclick="InfoProducts()">
